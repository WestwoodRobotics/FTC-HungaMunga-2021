 ...
 * is explained below.
 */
//@TeleOp(name = "DetectingCustomShippingElement", group = "Concept")
public class DetectingCustomShippingElement extends LinearOpMode {
    ...
    private static final String TFOD_MODEL_ASSET = "GameObjectsTry.tflite";
